...
const ORDER_ITEMS_API_URL = 'items'

export const ORDER_ITEMS_API_URL_ADMIN = `${ORDER_ITEMS_API_URL}/admin`
export const ORDER_ITEMS_API_URL_ADD = `${ORDER_ITEMS_API_URL}/add`
